...
const Post = (props) => {
  ...
  const [doesUserLiked, setDoesUserLiked] = useState(props.data.likes.filter((like) => like.username === props.user?.username).length !== 0);
  ...
  return (
    <div key={props.data.id} className="post">
      ...
      <div className="postData">
        ...
        {props.user && doesUserLiked && (
          <button className="btnUnLikes" onClick={unLike}>
